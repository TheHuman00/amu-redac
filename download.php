                ...
                <form method="post" action="download?id=<?php echo $id; ?>" class="clearfix">
                    <div class="row gx-5 mb-4">
                        <div class="col-md-6">
                            ...
                            <input class="form-control py-4" id="inputName" name="nom" type="text" placeholder="Nom et prénom" <?php if (!empty($rapport['nom'])) {
                                                                                                                                    echo "value=\"" . $rapport["nom"] . "\"";
                                                                                                                                } ?> />
                        </div>
                        <div class="col-md-6">
                            <label class="text-dark mb-2" for="inputDate">Service agréé</label>
                            <input class="form-control py-4" id="inputDate" name="service" type="text" placeholder="Nom du service" <?php if (!empty($rapport['service'])) {
                                                                                                                                        echo "value=\"" . $rapport["service"] . "\"";
                                                                                                                                    } ?> />
                        </div>
                    </div>
                    <div class="row gx-5 mb-4">
                        <div class="col-md-6">
                            ...
                            <input class="form-control py-4" id="inputName" name="annee" type="text" placeholder="Année de promotion" <?php if (!empty($rapport['annee'])) {
                                                                                                                                            echo "value=\"" . $rapport["annee"] . "\"";
                                                                                                                                        } ?> />
                        </div>
                        <div class="col-md-6">
