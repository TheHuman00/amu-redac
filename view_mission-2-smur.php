                ...
                <form method="post" action="view_mission-2-smur?id=<?php echo $id; ?>&mission=<?php echo $mission; ?>">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-floating mb-3">
                                <textarea class="form-control" id="autosize" name="antcd" style="min-height: 100px" placeholder="Effectuer une liste simple des antécédents connu surplace de la victime"><?php if ($exist_mission && !empty($find_mission['antcd'])) {
