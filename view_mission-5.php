...
if (isset($_POST['sauv_1'])) {
    ...
    if (empty($errors)) {
        ...
        $query = $database->db_prepare("INSERT INTO missions_ambu (id_rapports,id_mission,diff,eval,patho,ressenti,fini) VALUES (?,?,?,?,?,?,'true') ON DUPLICATE KEY UPDATE diff = ?, eval = ?, patho = ?, ressenti = ?, fini = 'true'");
        ...
        if ($query->execute()) {
            ...
            redirect("view_mission?id=$id&mission=$mission&sauv=ok", false);
        } else {
        ...
        redirect(`view_mission-5?id=$id&mission=$mission`);
    }
}
    ...
    <div class="container">
        <div class="row gx-5">
            ...
            <div class="col-lg-8 col-xl-9">
                <form method="post" action="view_mission-5?id=<?php echo $id; ?>&mission=<?php echo $mission; ?>">
