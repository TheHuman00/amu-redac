            ...
            <div class="col-lg-8 col-xl-9">
                <form method="post" action="view_mission?id=<?php echo $id; ?>&mission=<?php echo $mission; ?>">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <textarea class="form-control" id="autosize" name="editor" style="min-height: 100px" placeholder="Essayer de donner la meilleur image de la situation à l'arrivée"><?php if ($exist_mission) {
