...
if (isset($_POST['sauv_1'])) {
    ...
    if (empty($errors)) {
        ...
        $query = $database->db_prepare("INSERT INTO missions_ambu (id_rapports,id_mission,actes,reevalution,autre_moyen,actes_stagiaire,surveillance) VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE actes = ?, reevalution = ?, autre_moyen = ?, actes_stagiaire = ?, surveillance = ?");
            ...
            <div class="col-lg-8 col-xl-9">
                <form method="post" action="view_mission-4?id=<?php echo $id; ?>&mission=<?php echo $mission; ?>">
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                                <textarea name="editor" class="form-control" id="autosize" style="min-height: 100px"><?php if ($exist_mission && !empty($find_mission['actes'])) {
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                                <textarea name="editor1" class="form-control" id="autosize" style="min-height: 100px"><?php if ($exist_mission && !empty($find_mission['reevalution'])) {
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                                <textarea name="editor2" class="form-control" id="autosize" style="min-height: 100px"><?php if ($exist_mission && !empty($find_mission['autre_moyen'])) {
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                                <textarea name="editor3" class="form-control" id="autosize" style="min-height: 100px"><?php if ($exist_mission && !empty($find_mission['actes_stagiaire'])) {
                    ...
                    <div class="card mb-5">
                        ...
                        <div class="card-body">
                            <div class="form-floating mb-3">
                                <textarea name="editor4" class="form-control" id="autosize" style="min-height: 100px"><?php if ($exist_mission && !empty($find_mission['surveillance'])) {
