...
if (isset($_POST['sauv_1'])) {
    ...
    if (empty($errors)) {
        ...
        $query = $database->db_prepare("INSERT INTO missions_smur (id_rapports,id_mission,a,b,c,d,e) VALUES (?,?,?,?,?,?,?) ON DUPLICATE KEY UPDATE a = ?, b = ?, c = ?, d = ?, e = ?");
        ...
        if ($query->execute()) {
            ...
            redirect("view_mission-4-smur?id=$id&mission=$mission&sauv=ok", false);
        } else {
        ...
        redirect(`view_mission-3-smur?id=$id&mission=$mission`);
    }
}
    ...
    <div class="container">
        <div class="row gx-5">
            ...
            <div class="col-lg-8 col-xl-9">
                <form method="post" action="view_mission-3-smur?id=<?php echo $id; ?>&mission=<?php echo $mission; ?>">
